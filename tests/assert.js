var assert = {
  ...
  isTrue: function(assertionToCheck, description) {
    if (!assertionToCheck) {
      ...
      document.getElementById("tests").innerHTML += "<img src='"+ 'https://static.superdeluxe.com/dankland/generators/fail-meme.jpg' +"'><br />";
    } else {
      document.getElementById("tests").innerHTML += ("🍏 Test: '" + description + "' completed successfully!" + "<br />");
      document.getElementById("tests").innerHTML += "<img src='"+ 'http://imworld.aufeminin.com/story/20140423/cat-meme-218141_w650.jpg' +"'><br />";
    }
  }
};
